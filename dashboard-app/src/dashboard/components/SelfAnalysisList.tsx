...
type Props = AnalysisListInteractionProps & { rows: SelfSalesRow[] }

export function SelfAnalysisList({ rows, activeSkuGroupKey, onOrderedSkuGroupKeysChange, ...actions }: Props) {
