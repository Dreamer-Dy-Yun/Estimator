...
- Backend should validate missing or invalid `companyUuid` as request validation failure, preferably HTTP 400 or 422 with an `ApiErrorResponse` message that identifies `companyUuid`.
