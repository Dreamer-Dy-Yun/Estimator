# ARCHIVED OLD CONTRACT

This file is kept only for historical reference.
Do not implement new backend behavior from this document.
Use `MD/backend-api/dashboard-api-contract-catalog.md` and `MD/backend-api/backend-api-spec.md` instead.
