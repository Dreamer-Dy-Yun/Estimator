...
- `dashboard-app/src/api/mock/secondaryStockOrderCalcApi.ts` builds mock stock-order calculation responses, including the shared inbound split planning source.
